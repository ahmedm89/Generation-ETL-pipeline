...
def create_table():
    ...
    try:
        ...
        create_transactions_table = '''CREATE TABLE IF NOT EXISTS transactions_table(
                                time_stamp      timestamptz,
                                store_id        integer,
                                total_price      float
                                );'''
        ...
        # executing tables
        cur.execute(
            f' {create_customer_table}{create_store_table}{create_product_table}{create_basket_table}{create_transactions_table}')
